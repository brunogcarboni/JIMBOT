...
Obs.: Please, use Linux.
    ...
    _Obs.: Replace X/X by the IP and range you found and it's corresponding range, if you didn't take the same aproach as we did and connected the Board to a router, the IP and range is usually 192.168.X.X/XX
